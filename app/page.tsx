      ...
      <div className="flex flex-col gap-8 items-center justify-center">
        ...
        <div className="flex flex-col items-center mt-36 mb-4 gap-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 items-center justify-center gap-4 p-4">
            <div className="flex bg-[#97C11F] rounded-full p-2 min-w-[400px] min-h-[80px] items-center gap-2">
              <Image width={60} height={60} alt="profil" src={"/tafta-logo.png"}></Image>
              <p>Satıcı 1 Bölgesi</p>
            </div>
            <div className="flex bg-[#F0D300] rounded-full p-2 min-w-[400px] min-h-[80px] items-center gap-2">
              <Image width={60} height={60} alt="profil" src={"/tafta-logo.png"}></Image>
              <p>Satıcı 2 Bölgesi</p>
            </div>
            <div className="flex bg-[#E42528] rounded-full p-2 min-w-[400px] min-h-[80px] items-center gap-2">
              <Image width={60} height={60} alt="profil" src={"/tafta-logo.png"}></Image>
              <p>Satıcı 3 Bölgesi</p>
            </div>
            <div className="flex bg-[#F9F9F9] rounded-full p-2 min-w-[400px] min-h-[80px] items-center gap-2">
              <Image width={60} height={60} alt="profil" src={"/tafta-logo.png"}></Image>
