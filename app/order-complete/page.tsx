    ...
    return (
        <div className="flex flex-col items-center  text-center min-h-screen p-6 mt-8">
            <div className="flex gap-4 mb-6">
                <div className="flex flex-row bg-blue-100 p-2 rounded-md items-center gap-2">
                    <Image src="/complete-order-id.png" width={40} height={40} alt="order-id-icon"></Image>
                    <span>Sipariş Numaran: <strong>{orderNumber}</strong></span>
                </div>
                <div className="flex flex-row bg-blue-100 p-2 rounded-md flex items-center gap-2">
                    <Image src="/complete-order-iban.png" width={40} height={40} alt="order-id-iban"></Image>
                    <span>IBAN: <strong>TR33 0006 1005 1978 6457 8413 26</strong></span>
                </div>
            </div>
            ...
            <p className="text-lg mb-4 text-[#2A3788]">
                ...
                Güzel şeyler zaman alır ama buna değecek. Üretime başlayabilmemiz için
                ödemenin, <strong>sipariş numaran açıklama kısmına yazılarak</strong> IBAN’a
                yapılması ve <strong>3 iş günü</strong> içinde tamamlanması yeterli.
            </p>
            <p className="text-[#2A3788]">Merak etme, her adımda yanında olacağız.</p>
